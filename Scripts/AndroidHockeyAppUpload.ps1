...
$filePath = "$env:APPVEYOR_BUILD_FOLDER\$env:ANDROID_PROJECT_PATH\bin\Android\AnyCPU\Release\$env:APP_NAME-v$env:APPVEYOR_BUILD_VERSION.apk"
$method = "POST"
$param = "ipa"
$header = @{"X-HockeyAppToken"="$env:HOCKEYAPP_API_TOKEN"}
$commitSha = "$env:APPVEYOR_REPO_COMMIT"
$commitMessage = "$env:APPVEYOR_REPO_COMMIT_MESSAGE"
$repoUrl = "https://github.com/Noxalus/BulletMLI-Editor"
$buildServerUrl = "https://ci.appveyor.com/project/Noxalus/bulletmli-editor/build/$env:APPVEYOR_BUILD_VERSION"
